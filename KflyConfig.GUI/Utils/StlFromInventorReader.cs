...
// </summary>
// --------------------------------------------------------------------------------------------------------------------
//Small changes to work with colors for inventor files
...
namespace KFly.GUI
{
    ...
    /// </remarks>
    public class StLFromInventorReader : ModelReader
    {
        /// <summary>
        ...
        public StLFromInventorReader(Dispatcher dispatcher = null)
            : base(dispatcher)
        {
...
#pragma warning restore 168
            ...
            var hasColor = true;//attrib[0].Equals('1');
            ...
            if (hasColor)
            {
                ...
                var currentColor = Color.FromRgb(Convert.ToByte(b), Convert.ToByte(g), Convert.ToByte(r));
